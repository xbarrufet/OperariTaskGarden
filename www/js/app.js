...
.state('tab.tasquesSetmana', {
    ...
    views: {
     ...
     .state('tab.llistaFotos', {
    url: '/llistaFotos',
    views: {
      'vTasques': {
        templateUrl: 'templates/llistaFotos.html',
        controller: 'TasquesCtrl'
      }
    }
  })
  ...
  .state('tab.clients', {
    ...
    views: {
      'vClients': {
        templateUrl: 'templates/clientsLlista.html',
        controller: 'TasquesCtrl'
      }
    }
  }) 
  .state('tab.clientDetall', {
    ...
    views: {
      'vClients': {
        templateUrl: 'templates/clientDetall.html',
        controller: 'TasquesCtrl'
      }
    }
  })
 ...
 ;
  ...
  $urlRouterProvider.otherwise('/tab/tasquesDia');
